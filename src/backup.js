...
const WheelContainer = ({ onDrop, wheel, setIsOpen, task, setTask }) => {
  ...
  return (
    <motion.div
      ...
      animate={blinking ? { backgroundColor: ["#1E3A8A", "#F59E0B", "#1E3A8A"] } : { backgroundColor: "rgba(0,0,0,0)" }}
      transition={blinking ? { duration: 1, repeat: Infinity, ease: "easeInOut" } : { duration: 0 }}
      style={{
